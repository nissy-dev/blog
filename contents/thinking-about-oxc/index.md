...
開発体制が完全なボランティアベースになってしまったので、CSS や HTML などに関する開発に全く着手できていないのが現状で、今後もかなりスローペースでの開発になりそうです。また、近年 Astro や Qwik などの独自のパーサーが必要なのフレームワークが公開されることが多く、これらの対応についても全く着手できていないのが現状です。今後もこのようなフレームワークが増えることを考えると、いくら開発者がいても足りないみたいな感じにはなりそうで、これらをどうやってサポートするのかは考える必要がありそうです。
